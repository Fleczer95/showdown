...
| Goal credit         | Each completed run counts once, independently of opponent arrival/completion. Normal losses, even on question one, count; quitting and unfinished runs do not.                                                                    |
...
| Prizes              | Completed-run milestones only: complete N runs within the edition to receive a specified, previewable prize. Thresholds and prizes are configurable; grants are automatic with a celebration.                                     |
| Offline completion  | Save goal progress and grant prizes locally immediately, even while result upload is pending.                                                                                                                                     |
