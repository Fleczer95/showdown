                                              ...
                                              <Stack direction='horizontal' gap='md' align='center'>
                                                      ...
                                                      style={[
                                                          styles.iconBox,
                                                          {
                                                              backgroundColor: earned
                                                                  ...
                                                                  : hexToRgba(theme.colors.text, 0.05),
                                                  ...
                                                  <Stack gap='xs' flex={1}>
                                                      <Text
                                                          variant='body'
                                                          weight='semibold'
                                                          color={earned ? 'text' : 'textSecondary'}
                                                      >
                            ...
                            <Stack gap='xl'>
                                <View style={{ alignItems: 'center', marginTop: scale(16), marginBottom: scale(8) }}>
                                    ...
                                    <Text
                                        ...
                                        color='textSecondary'
                                        align='center'
                                        style={{ lineHeight: 24, paddingHorizontal: scale(16) }}
                                    >
                                    ...
                                    <Stack direction='horizontal' justify='between' align='center'>
                                        ...
                                        >
                                            <Text variant='body' weight='bold' color={earned ? accent : 'textMuted'}>
                                                {t('progression.xpGained', {
                                                    n: ACHIEVEMENT_XP_ONE_OFF.toLocaleString(locale),
                                                })}
                                            </Text>
                                        </View>
                                    </Stack>
