...
export const LEVEL_MAP: readonly LevelNode[] = [
    ...
    { level: 3, xp: 400 },
    { level: 4, xp: 750 },
    { level: 5, xp: 1200, reserved: true },
    { level: 6, xp: 1800 },
    { level: 7, xp: 2600 },
    { level: 8, xp: 3600, rewardId: 'theme-champion' },
    { level: 9, xp: 4900 },
    { level: 10, xp: 6500 },
    { level: 11, xp: 8500, reserved: true },
    { level: 12, xp: 11000 },
    { level: 13, xp: 14000 },
    { level: 14, xp: 17500, reserved: true },
    { level: 15, xp: 22000, rewardId: 'theme-legend' },
];
