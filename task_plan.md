...
- [x] **Fact-check The Drop's statistics** (EN + PL) — replaced the original common-knowledge bank (bones=206, piano keys, soccer players, alphabet) with 14 _surprising-but-verifiable_ statistics. Common-knowledge trivia broke the game: if everyone knows the answer there is no reason to spread the bank across options. New bank uses figures the player is genuinely uncertain about (heartbeats/day ≈100k, languages ≈7,000, ocean O₂ ≈50%, people ever born ≈117bn, Great Wall ≈21,000km, body cells ≈37 trillion, fresh water ≈3%, Indonesia islands ≈17,000, neurons ≈86bn, France time zones =12, etc.), all real and rounded for legibility
...
- [ ] _(Phase 3 sub-decision, parked)_ When an IAP pack unlocks, seed its questions' counts to the current pool minimum so new content blends rather than starving the base pool
